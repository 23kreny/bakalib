...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 0.9.3 on Tue Sep  3 21:35:34 2019
#
...
class frameMain(wx.Frame):
    ...
    def __do_layout(self):
        ...
        buttonTimetable = wx.StaticBitmap(self, wx.ID_ANY, wx.Bitmap("A:\\Git\\Python\\bakalaris\\bitmaps\\rozvrh.png", wx.BITMAP_TYPE_ANY))
        sizer_1.Add(buttonTimetable, 0, wx.ALIGN_CENTER | wx.ALL | wx.EXPAND, 5)
        buttonGrades = wx.StaticBitmap(self, wx.ID_ANY, wx.Bitmap("A:\\Git\\Python\\bakalaris\\bitmaps\\znamky.png", wx.BITMAP_TYPE_ANY))
        sizer_1.Add(buttonGrades, 0, wx.ALIGN_CENTER | wx.ALL | wx.EXPAND, 5)
        buttonAbsence = wx.StaticBitmap(self, wx.ID_ANY, wx.Bitmap("A:\\Git\\Python\\bakalaris\\bitmaps\\absence.png", wx.BITMAP_TYPE_ANY))
        sizer_1.Add(buttonAbsence, 0, wx.ALIGN_CENTER | wx.ALL | wx.EXPAND, 5)
